...
<div class="container">
    ...
    <div class="hero-container">
        <div class="hero-flex-container">
            <div class="hero-item hero-one">
                <div class="hero-video flex-video"> 
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="ytplayer embed-responsive-item" type="text/html" src=''></iframe>
                    </div>
                </div>
            </div>
            <div class="hero-item hero-two">
                <h1 class="center-hero"> The Latest Collection</h1>
                <p class="center-hero-text text-md">Our newest fabric, is engineered to keep you feeling cool during super sweaty studio sessions.</p>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 card-mobile">
            ...
            <div class="card-body">
               ...
               <p class="card-text text-muted">The best hoodie ever.</p>
                <p class="card-text">$50</p>
                <a href="products.php" class="btn btn-primary">Buy</a>
            </div>
            </div>
    ...
    <div class="row center-container">
        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
            ...
            <div class="card-body">
                <h4 class="card-title">Women's Tops</h4>
                <p class="card-text text-muted">Our best collection of all time.</p>
        ...
        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
            ...
            <div class="card-body">
                <h4 class="card-title">Women's Pants</h4>
                <p class="card-text text-muted">Our best collection of all time.</p>
                <a href="products.php" class="btn btn-primary">View</a>
            </div>
            </div>
